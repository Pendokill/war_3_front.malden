...
_waitTime = 1800/Param7;

// Random Weather
while { true } do {

    _waitTime setOvercast selectRandom _setRandom; // selectRandom is the new engine solution to BIS_fnc_selectRandom. This will select a random weather pattern from the array. Values: 0 = Sunny, clear skies   1 = Stormy, complete overcast.
